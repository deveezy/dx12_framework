...
// Window destructor is not public, then we need to create wrapper
struct MakeWindow : public Window 
{
    MakeWindow(
        HWND hWnd, const std::wstring& windowName, 
    ...
    else
    {
        ...
        for (UINT i = 0; dxgiFactory->EnumAdapters1(i, &dxgiAdapter1) != DXGI_ERROR_NOT_FOUND; ++i)
        {
                ...
                dxgiAdapterDesc1.DedicatedVideoMemory > maxDedicatedVideoMemory)
            {
                ...
                ThrowIfFailed(dxgiAdapter1.As(&dxgiAdapter4)); // set adapter1 to adapter4
            }
        }
    }
    return dxgiAdapter4;
